<div class="classified_category_main clearfix">
<?php foreach ($this->categories as $category) :?>
    <div class="browse_category">
        <div class="item-category-browser">
            <?php 
                $children = $category->getSubCategory();
            ...
            <?php if (($children_length > 0) && ($children_length <= 5)) : ?>
                <ul>
                    <?php foreach($children as $child) : ?>
                        <li><span class="fa fa-angle-right"></span><?php echo $this->htmlLink($child->getHref(), $this -> translate($child->getTitle()))?></li>
                    <?php endforeach; ?>
                </ul>
...
<script type="text/javascript">
    ...
    en4.core.runonce.add(function() {
        $$('.btn-toggle-more-category').addEvent('click', function(){
            ...
            category_item.toggleClass('classified-category-expand');

            if ( category_item.hasClass('classified-category-expand') ) {
     ...
     $$('.btn-toggle-more-category').addEvent('outerClick', function(){
        ...
        if(category_item.hasClass('classified-category-expand')){
            category_item.removeClass('classified-category-expand');
        }
     })
