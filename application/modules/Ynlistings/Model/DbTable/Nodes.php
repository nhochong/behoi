...
class Ynlistings_Model_DbTable_Nodes extends Engine_Db_Table {
	...
	public function updateTree() {
		...
		$sql = new Zend_Db_Expr("update $table set level = (select count(parent.title) from (select * from $table ) as parent where $table.pleft BETWEEN parent.pleft and parent.pright)-1");
