<?php
class Ynlistings_UltimatevideoController extends Core_Controller_Action_Standard
{
	...
	public function manageAction()
	{
		...
		$this -> view -> paginator = $paginator = $tableMappings -> getWidgetUltimatevideosPaginator($params);
	...
	public function listAction()
	{
		...
		$this -> view -> paginator = $paginator = $tableMapping->getUltimatevideosPaginator($params);
