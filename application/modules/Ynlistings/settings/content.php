...
return array(
    ...
    array(
        'title' => 'Profile Listing Ultimate Video',
        'description' => 'Displays a list of videos of Ultimate Video plugin on the listing.',
        'category' => 'YN Listings',
        'type' => 'widget',
        'name' => 'ynlistings.listing-ultimate-videos',
        'isPaginated' => true,
        'defaultParams' => array(
