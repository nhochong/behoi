...
<div class="listing_options">
    <?php if( $this->listing->isOwner($this->viewer())): ?>
        ...
        <?php endif;?>
        <?php if(Engine_Api::_()->hasItemType('ynultimatevideo_video')): ?>
        <?php echo $this->htmlLink(
        array('route' => 'ynlistings_extended','controller' => 'ultimatevideo','action' => 'list', 'listing_id' => $this->listing->getIdentity()),
        $this->translate('Add Ultimate Videos'),
        array('class' => 'buttonlink icon_listings_add_videos')) ?>
        <?php endif;?>
