...
class YounetCore_AdminSettingsController extends Core_Controller_Action_Admin
{
    public function indexAction()
    {
        $this->view->navigation = $navigation = Engine_Api::_()->getApi('menus', 'core')
            ->getNavigation('younet_core_admin_main', array(), 'younet_core_admin_main_settings');
        $this->view->setting_form = $setting_form = new YounetCore_Form_Admin_Settings_Global();
