...
?>
<div class="ynmember-container clearfix">
    ...
    <script>
        ...
        window.addEvent('domready', function()
        {
            ...
            $$('.field-privacy-selector').addEvent('outerClick', function(event) {
            ...
            $('anniversary').removeEvents('keydown').addEvent('keydown', function(){
