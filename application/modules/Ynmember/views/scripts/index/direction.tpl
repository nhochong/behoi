...
<div id="ynmember_direction">
<h4><?php echo $this->translate("Get Direction");?></h4>
<div class="ynmember_widget_location_direction">
    ...
    <span class="close-btn" id="ynmember_location_direction_close_btn">x</span>
</div>
<div class="ynmember_widget_location_direction get_current_position">
...
<div class="ynmember_widget_location_direction ynmember_widget_location_destination">
	<label for="destination"><?php echo $this->translate("Destination");?></label>
	<img src="application/modules/Ynmember/externals/images/location_pin.png" />
	<span><?php echo $this->item->location;?></span>
</div>
<div class="ynmember_widget_location_direction ynmember_widget_location_direction_button">
    <label>&nbsp;</label>
...
{
	$('ynmember_location_direction_close_btn').addEvent('click', function(e) {
		$('pac-input').set('value','');
		fromPoint = null;
    });
});
