...
<script type="application/javascript">
    ...
    var set_rating = window.set_rating = function(id) {
        ...
        for(var x=1; x<=parseInt(rating); x++) {
            $('rate_'+x+'_'+id).set('class', 'ynmember_rating_star_big_generic ynicon yn-star');
        }
        for(var x=parseInt(rating)+1; x<=5; x++) {
            $('rate_'+x+'_'+id).set('class', 'ynmember_rating_star_big_generic ynicon yn-star ynmember_star_disable');
        }
...
<script type="application/javascript">
    ...
    var set_rating_general = window.set_rating_general = function() {
        ...
        for(var x=1; x<=parseInt(rating); x++) {
            $('rate_'+x).set('class', 'ynmember_rating_star_big_generic ynicon yn-star');
        }
        for(var x=parseInt(rating)+1; x<=5; x++) {
            $('rate_'+x).set('class', 'ynmember_rating_star_big_generic ynicon yn-star ynmember_star_disable');
        }
