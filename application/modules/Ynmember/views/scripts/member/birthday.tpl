				...
				<div class="ynmember-member-item-more">
					...
					<?php
						...
						<?php
							...
							{
								$str_workplace = "<a ref='nofollow' target='_blank' href='https://www.google.com/maps?q={$workplaces->latitude},{$workplaces->longitude}'>{$workplaces->company}</a>";
							}
						?>
					...
					<?php
						...
						?>
					<span><span class="ynicon yn-users"></span> <?php echo $this-> translate("Groups:");?> 
					<?php if (count($groups)):?>
...
<script type="text/javascript">
	...
	window.addEvent('domready', function(){
		$$('.ynmember-member-item-more-btn').addEvent('click', function(){
