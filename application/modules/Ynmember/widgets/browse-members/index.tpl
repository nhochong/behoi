<?php if( count($this->paginator) > 0 ): ?>
				...
				<div class="ynmember-member-item">
					...
					<div class="ynmember-member-item-info">
						...
						<div class="ynmember-member-item-more">
							...
							<!-- living places -->
							<span><span class="ynicon yn-map-marker"></span> <?php echo $this-> translate("Lives in");?>
								<?php
							...
							?>
							<span><span class="ynicon yn-user-group"></span> <?php echo '<span>'.$this-> translate("Groups:").'</span>';?>
								<?php if (count($groups)):?>
						...
						<div class="ynmember-review-item-reviews">
							...
							<a href="<?php echo $this->url(array("controller" => "review", "action" => "user", "id" => $user -> getIdentity()),'ynmember_general');?>">
								<?php echo $this -> translate(array("%s review", "%s reviews" , $reviewCount), $this->locale()->toNumber($reviewCount));?>
							</a>
						</div>
					</div>
				</div>
	...
	<script type="text/javascript">
		...
		$$('.ynmember-member-item-option .ynmember-member-item-more-btn').addEvent('outerClick', function(){
