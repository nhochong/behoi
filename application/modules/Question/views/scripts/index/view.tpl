...
<div class="qa_question_body">
 ...
 <div class='qa_browse_photo'>
  ...
  <?php if( $this->message ): ?>
    <div class='result_message'><?php echo $this->message ?></div><br/>
  <?php endif; ?>
  ...
  <div class="qa_answers_list">
      ...
      <span id="questionvoite_likes_<?php echo $this->question->getIdentity() ?>" ><?php echo $this->translate("Score %s", $this->question->getVotes('all'))?></span>
     &bull;
    ...
    <div class="browsebl">
        <?php echo $this->browse_by->render($this); ?>
        <div class="qa_browse_by"><?php echo $this->translate('Browse by'); ?></div>
    </div>    
	</div>
    <ul class="qa_browse">
      ...
      <?php echo $this->RenderSimpleWidget('question.answer-comment', array('action' => 'list',"type"=>"answer", "id"=>$this->best_answer->answer_id)); ?></li>
