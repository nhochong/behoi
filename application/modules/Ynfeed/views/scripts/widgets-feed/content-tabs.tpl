  ...
  <ul> 
    ...
    <?php if (count($this->filterTabs) > $this->contentTabMax || $this->canCreateCustomList): ?>
      <li class="ynfeed_tabs_feed_tab ynfeed_tabs_feed_tab_more" id="ynfeed_tabs_feed_tab_more" >
        ...
        <a href="javascript:void(0);"><span><?php echo count($this->filterTabs)>0 && $this->contentTabMax !=0 ?$this->translate('More'):count($this->filterTabs)<1?$this->translate('More'):$this->translate('Filter') ?></span>&nbsp;<span class="ynicon yn-caret-down"></span></a>
      </li>
    <?php endif; ?>
  </ul>
</div>
