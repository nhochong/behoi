...
<div class='global_form'>
  ...
  <form method="post">
    <div>
      <h3><?php echo $this->translate("Approve the selected experience(s)?") ?></h3>
      <p>
        <?php echo $this->translate("Are you sure that you want to approve %d experience(s)?", $this->count) ?>
      </p>
      <br />
      <p>
  ...
  <form>
    <div>
      <h3><?php echo $this->translate("Aprrove the selected experience(s)?") ?></h3>
      <p>
        <?php echo $this->translate("Please select a experience to aprrove.") ?>
      </p>
      <br/>
