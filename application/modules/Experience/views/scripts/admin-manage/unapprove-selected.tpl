...
<div class='global_form'>
  ...
  <form method="post">
    <div>
      <h3><?php echo $this->translate("Unapprove the selected experience(s)?") ?></h3>
      <p>
        <?php echo $this->translate("Are you sure that you want to unapprove %d experience(s)?", $this->count) ?>
      </p>
      <br />
      <p>
  ...
  <form>
    <div>
      <h3><?php echo $this->translate("Unaprrove the selected experience(s)?") ?></h3>
      <p>
        <?php echo $this->translate("Please select a experience to unaprrove.") ?>
      </p>
      <br/>
