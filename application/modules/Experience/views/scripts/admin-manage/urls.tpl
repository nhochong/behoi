...
<table class='admin_table'>
  ...
  <tbody>
    <?php foreach ($this->paginator as $item): ?>
      <tr>
        <td class="experience_check"><input type='checkbox' class='checkbox' value="<?php echo $item->link_id ?>"/></td>
        ...
        <td>
          <?php echo $this->htmlLink(
                  array('route' => 'default', 'module' => 'experience', 'controller' => 'admin-manage', 'action' => 'delete-link', 'id' => $item->link_id),
                  $this->translate('delete'),
                  array('class' => 'smoothbox')) ?>
          |
          <?php if(!$item->cronjob_enabled):?>
               <?php echo $this->htmlLink(
                      array('route' => 'default', 'module' => 'experience', 'controller' => 'admin-manage', 'action' => 'enable-cron', 'id' => $item->link_id),
                      $this->translate('enable'),
                      array('class' => 'smoothbox')) ?>
          <?php else:?>
               <?php echo $this->htmlLink(
                      array('route' => 'default', 'module' => 'experience', 'controller' => 'admin-manage', 'action' => 'disable-cron', 'id' => $item->link_id),
