<script type="text/javascript">
    ...
    var select_experience = function(item, id)
    {
        ...
        if(count == $$('td.experience_check input[type=checkbox]').length) {
    ...
    function actionSelected(exportTo){
        $('action_selected').action = en4.core.baseUrl +'experiences/export/export';
        var selectedIds = getCookie("cbcookie");
        if(selectedIds == "") {
            alert("<?php echo $this->translate('Please choose the experiences to export!')?>")
            return;
        }
...
<div style="overflow: auto">
    <table class='export_table'>
        ...
        <tr>
            <td class="experience_check"><input type='checkbox' class='checkbox' value="<?php echo $item->experience_id ?>" onchange="select_experience(this,<?php echo $item->experience_id?>);"/></td>
