<?php
class Experience_Widget_ProfileExperiencesController extends Engine_Content_Widget_Abstract
{
  ...
  public function indexAction()
  {
    ...
    $this->view->paginator = $paginator = Engine_Api::_()->experience()
            ->getExperiencesPaginator(array('orderby' => 'creation_date',
                                      'draft'  => '0',
                                      'is_approved' => '1',
                                      'visible' => '1',
    ...
    // Don't render layout if no experience gotten
    ...
    $this->view->items_per_page = $settings->getSetting('experience_page', 10);
  }
