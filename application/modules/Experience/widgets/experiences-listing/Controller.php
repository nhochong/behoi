...
class Experience_Widget_ExperiencesListingController extends Engine_Content_Widget_Abstract
{
    public function indexAction()
    {
        ...
        $form = new Experience_Form_Search();
        // Process form
        ...
        $paginator = Engine_Api::_()->experience()->getExperiencesPaginator($params);
