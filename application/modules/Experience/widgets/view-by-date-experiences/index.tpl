...
var sm = 0;
var sd = 0;
var experience_year = now.getFullYear(); // Working Date
var m = now.getMonth();
var d = now.getDate();
var l = 0;
var t = 0;
...
function DrawCalendar() {
  ...
  var sCal = "<table class='experience-view-by-date'><tr class ='layout_core_menu_main' style=\"height: 42px;\"><td class=\"cellButton1\"><a href=\"javascript: PrevMonth();\" title=\"Previous Month\" style=\"text-align: center;\";><i class='fa fa-angle-left'></i></a></td>"+
    ...
    "<td class=\"cellMonth\" colspan=\"1\">"+ experience_year + "</td>"+
    ...
    sa + "</td></tr>";
  var wDay = 1;
  var wDate = new Date(experience_year,m,wDay);
  if(isLeapYear(wDate)) {
    MonthLengths[1] = 29;
  } else {
    MonthLengths[1] = 28;
...
function ReturnDay(day) {
  var date = experience_year+"-"+ (m+1)+"-"+day;
