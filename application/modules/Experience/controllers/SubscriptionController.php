<?php
class Experience_SubscriptionController extends Core_Controller_Action_Standard
{
  ...
  public function init()
  {
    ...
    // Get subject
    if( ($experience_id = $this->_getParam('experience_id')) &&
        ($experience = Engine_Api::_()->getItem('experience', $experience_id)) instanceof Experience_Model_Experience ) {
      $subject = $experience->getOwner('user');
  ...
  public function addAction()
  {
    ...
    if( $subscriptionTable->checkSubscription($user, $viewer) ) {
      ...
      $this->view->message = Zend_Registry::get('Zend_Translate')
          ->_("You are already subscribed to this member's experience.");
    ...
    $this->view->form = $form = new Core_Form_Confirm(array(
      'title' => 'Subscribe?',
      'description' => "Would you like to subscribe to this member's experience?",
    ...
    $this->view->status = true;
    $this->view->message = Zend_Registry::get('Zend_Translate')
        ->_("You are now subscribed to this member's experience.");
  ...
  public function removeAction()
  {
    ...
    if( !$subscriptionTable->checkSubscription($user, $viewer) ) {
      $this->view->status = true;
      $this->view->message = Zend_Registry::get('Zend_Translate')
          ->_("You are already not subscribed to this member's experience.");
    ...
    $this->view->form = $form = new Core_Form_Confirm(array(
      'title' => 'Unsubscribe?',
      'description' => "Would you like to unsubscribe from this member's experience?",
      'class' => 'global_form_popup',
    ...
    $this->view->status = true;
    $this->view->message = Zend_Registry::get('Zend_Translate')
        ->_('You are no longer subscribed to this member\'s experience.');
