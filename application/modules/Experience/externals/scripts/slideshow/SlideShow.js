...
Element.Properties.slideshow = {
	...
	set: function(options){
		this.get('slideshowexperience').setup(options);
		return this;
	},

	get: function(){
		var instance = this.retrieve('slideshowexperience');
		if (!instance){
			instance = new SlideShow(this, {}, true);
			this.store('slideshowexperience', instance);
		}
		return instance;
	}
...
Element.implement({
	...
	playSlideShow: function(options){
		this.get('slideshowexperience').setup(options).play();
		return this;
	},

	pauseSlideShow: function(){
		this.get('slideshowexperience').pause();
		return this;
	}
